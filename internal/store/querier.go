...
type Querier interface {
	...
	CreateUserWithAdmin(ctx context.Context, arg CreateUserWithAdminParams) (User, error)
	...
	UpdateUserPreferredLanguage(ctx context.Context, arg UpdateUserPreferredLanguageParams) (User, error)
